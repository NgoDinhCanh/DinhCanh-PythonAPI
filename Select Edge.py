...
#Code 
ref = uidoc.Selection.PickObjects(ObjectType.Edge,'Please select Edge')
fa = doc.GetElement(ref.ElementId)
edge = fa.GetGeometryObjectFromReference(ref)
get_edge = edge.AsCurve().ToProtoType()
