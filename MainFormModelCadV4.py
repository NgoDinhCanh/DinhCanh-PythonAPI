...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._groupBox1.Size = System.Drawing.Size(508, 116)
		...
		self._groupBox2.Location = System.Drawing.Point(12, 214)
		self._groupBox2.Name = "groupBox2"
		self._groupBox2.Size = System.Drawing.Size(508, 53)
		...
		self._comboBox3.Location = System.Drawing.Point(94, 22)
		self._comboBox3.Name = "comboBox3"
		self._comboBox3.Size = System.Drawing.Size(154, 21)
		...
		self._comboBox4.Location = System.Drawing.Point(94, 64)
		self._comboBox4.Name = "comboBox4"
		self._comboBox4.Size = System.Drawing.Size(154, 21)
		...
		self._progressWindow.Location = System.Drawing.Point(7, 18)
		self._progressWindow.Name = "progressWindow"
		self._progressWindow.Size = System.Drawing.Size(301, 23)
		...
		self._label1.Size = System.Drawing.Size(151, 21)
		self._label1.TabIndex = 12
		self._label1.Text = "Layer of Hatch Model Cad"
		...
		self._label2.Size = System.Drawing.Size(151, 21)
		self._label2.TabIndex = 13
		self._label2.Text = "Family Column"
		self._label2.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
		# 
		# label3
		# 
		self._label3.Location = System.Drawing.Point(7, 20)
		...
		# label4
		# 
		self._label4.Location = System.Drawing.Point(6, 64)
		...
		# label5
		# 
		self._label5.Location = System.Drawing.Point(280, 21)
		...
		# label6
		# 
		self._label6.Location = System.Drawing.Point(280, 64)
		...
		self._groupBox3.Controls.Add(self._comboBox4)
		self._groupBox3.Location = System.Drawing.Point(12, 117)
		self._groupBox3.Name = "groupBox3"
		self._groupBox3.Size = System.Drawing.Size(508, 101)
		self._groupBox3.TabIndex = 2
		self._groupBox3.TabStop = False
		self._groupBox3.Text = "Data Correc"
		# 
		# textBox1
		# 
		self._textBox1.ForeColor = System.Drawing.SystemColors.WindowText
		self._textBox1.Location = System.Drawing.Point(361, 23)
		self._textBox1.Name = "textBox1"
		self._textBox1.Size = System.Drawing.Size(133, 20)
		self._textBox1.TabIndex = 18
		self._textBox1.Text = "0"
		# 
		# textBox2
		# 
		self._textBox2.Location = System.Drawing.Point(361, 64)
		self._textBox2.Name = "textBox2"
		self._textBox2.Size = System.Drawing.Size(133, 20)
		...
		self.ClientSize = System.Drawing.Size(532, 268)
		self.Controls.Add(self._groupBox3)
		self.Controls.Add(self._groupBox2)
		self.Controls.Add(self._groupBox1)
		self.Name = "MainForm"
		self.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
		self.Text = "Model Column From AutoCad"
	...
	def BtnOkClick(self, sender, e):
		...
		var2 = self._comboBox2.SelectedItem
		...
		self.allFamilies_Ele = var2
		self.lvs_Ele1 = get_element(lv,var3)
		self.lvs_Ele2 = get_element(lv,var4)
		self.tx_Ele1 = float(var5)
		self.tx_Ele2 = float(var6)
		self.allHatchs = ndc.GetHatchLayerName(SelectedCadLink,self.btn_Ele)
		for hatch in self.allHatchs:
			ColumnData = ndc.ColumnData(hatch)
			self.allColumnData.Add(ColumnData)
		for columData in self.allColumnData:
			familySymbol = ndc.GetFamilySymbolColumn(self.allFamilies_Ele,columData[1],columData[2],"b","h")
			if familySymbol == None: continue
			self.a.Add(columData[1])
			# t = Transaction(doc,"Create Column")
			# t.Start()
			# instance = doc.Create.NewFamilyInstance(columnData.verticesColumn,familySymbol, doc.BaseLevel,StructuralType.Column)
